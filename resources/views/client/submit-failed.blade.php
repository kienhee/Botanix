...
@section('content')
    ...
    <section class="submit__success ">
        <h2 class="submit__success-title" style="color: #ef2e2e">The project has not been submitted yet</h2>
        <p class="submit__success-notice">Please try again or contact us</p>
