...
@php
    ...
    $menu = [
        ...
        [
        'name' => ' Trending',
        'classIcon' => 'menu-icon tf-icons bx bxs-hot',
        'route' => 'dashboard.trending.index',
        'children' => [],
        ],
        [
            'name' => 'Categories',
            ...
            'route' => '#',
            'children' => [['name' => 'Add new category', 'route' => 'dashboard.category.add'], ['name' => 'All categories', 'route' => 'dashboard.category.index']],
        ],
        [
            'name' => 'Projects',
            'classIcon' => 'menu-icon tf-icons bx bx-package',
            'route' => '#',
            'children' => [['name' => 'Add new project', 'route' => 'dashboard.project.add'], ['name' => 'All projects', 'route' => 'dashboard.project.index']],
        ],
        ...
        [
            ...
            'route' => '#',
            'children' => [['name' => 'Add new group', 'route' => 'dashboard.group.add'], ['name' => 'Group list', 'route' => 'dashboard.group.index']],
        ],
        [
            'name' => 'Users',
            'classIcon' => 'menu-icon tf-icons bx bxs-user-account',
            'route' => '#',
            'children' => [['name' => 'Add new member', 'route' => 'dashboard.user.add'], ['name' => 'User list', 'route' => 'dashboard.user.index']],
        ],
        [
        'name' => ' Media',
